...
#include "omtp_lecture3/plugins/ROSLogicalCameraPlugin.hh"

#include "omtp_lecture3/plugins/ARIAC.hh"
#include "omtp_lecture3/LogicalCameraImage.h"
...
void ROSLogicalCameraPlugin::Load(physics::ModelPtr _parent, sdf::ElementPtr _sdf)
{
  ...
  this->imagePub = this->rosnode->advertise<omtp_lecture3::LogicalCameraImage>(imageTopic_ros, 1, false);
...
void ROSLogicalCameraPlugin::OnImage(ConstLogicalCameraImagePtr &_msg)
{
  ...
  omtp_lecture3::LogicalCameraImage imageMsg;
