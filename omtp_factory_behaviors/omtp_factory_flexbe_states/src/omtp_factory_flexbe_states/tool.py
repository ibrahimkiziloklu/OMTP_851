...
class Tool(EventState):
	...
	-- joint_name		string[]	joint names

	-- tool_goal 		float[]		joint values		
	...
	def __init__(self, move_group, joint_name, tool_goal, action_topic = '/move_group'):
		'''
		Constructor
		'''
		...
		self._joint_names = joint_name
		self._goal = tool_goal
	...
	def on_enter(self, userdata):
		...
		for i in range(len(self._joint_names)):
			goal_constraints.joint_constraints.append(JointConstraint(joint_name=self._joint_names[i], position=self._goal[i]))
