...
class DetectorManager():
    ...
    def imageCb(self, data):
        ...
        input_img = Variable(input_img.type(FloatTensor)) #torch.cuda.FloatTensor
    ...
    def visualizeAndPublish(self, output, imgIn):
        ...
        for index in range(len(output.bounding_boxes)):
            ...
            # Create rectangle
            cv2.rectangle(imgOut, (int(x_p1), int(y_p1)), (int(x_p3), int(y_p3)), (0,0,0),2)
            #print(color)
            ...
            cv2.circle(imgOut,(center), 1, (0, 0, 0), 3)
